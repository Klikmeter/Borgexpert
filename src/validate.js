...
export const aanvraagSchema = z.object({
  ...
  adres_id: z.string().trim().regex(/^(adr-[a-z0-9]{1,40})?$/, 'Ongeldig adres.').default(''),
  adres_straat: txt(120),
  adres_huisnummer: txt(20),
  adres_postcode: txt(10),
  adres_plaats: txt(80),
  adres_gemeente: txt(80),
